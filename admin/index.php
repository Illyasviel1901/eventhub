...
<section class="section">
    <div class="shell">
        <div class="admin-stats" aria-label="Statistici EventHub">
            ...
            <article class="stat-card"><span>Cereri în așteptare</span><strong><?= $statistics['pending'] ?></strong><p>Rezervări cu status PENDING</p></article>
