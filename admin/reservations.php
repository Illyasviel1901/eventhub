...
$pageTitle = 'Solicitări';
$pageDescription = 'Gestionarea solicitărilor de rezervare EventHub.';
$currentPage = 'requests';
$basePath = '../';
require dirname(__DIR__) . '/includes/header.php';
?>
<section class="admin-page-heading"><div class="shell heading-row"><div><p class="eyebrow">Administrare</p><h1>Solicitări</h1><p>Verifică detaliile și procesează solicitările de rezervare ale clienților.</p></div><a class="button button-primary" href="reservation-create.php">Adaugă solicitare</a></div></section>
<section class="section admin-section"><div class="shell">
<?php if ($reservations === []): ?><div class="empty-state"><h2>Nu există solicitări</h2><p>Poți adăuga una în numele unui client existent.</p></div><?php else: ?>
