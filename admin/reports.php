...
<section class="section admin-section"><div class="shell report-grid">
    ...
    <article class="report-card"><p class="eyebrow">XLSX</p><h2>Export solicitări</h2><p>Descarcă solicitările împreună cu clientul, locația, data, participanții și statusul.</p><a class="button button-primary" href="export-reservations.php">Descarcă XLSX</a></article>
    <article class="report-card"><p class="eyebrow">PDF</p><h2>Raport general</h2><p>Generează o sinteză cu indicatori, distribuția statusurilor și lista solicitărilor.</p><a class="button button-primary" href="report-pdf.php">Descarcă PDF</a></article>
